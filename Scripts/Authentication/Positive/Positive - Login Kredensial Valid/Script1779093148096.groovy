...
'Klik Button Login'
WebUI.click(findTestObject('Authentication/button_Login'))

'Verifikasi Halaman Dashboard'
WebUI.verifyElementPresent(findTestObject('Authentication/Tittle_Header_Dashboard'), 5)
